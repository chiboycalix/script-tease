...
const FirstSection = () => {
  return (
    <div className="">
      ...
      <div className="relative bg-gradient-to-b from-slate-50 to-orange-200 mx-auto mt-[10rem] shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] w-full md:w-[86%] md:rounded-2xl py-[4rem] md:py-[8rem]">
        <h1 className="text-center xs:text-[1.5rem] sm:text-[1.7rem] md:text-[1.9rem] lg:text-[2rem] xl:text-[3rem]">
          Watch our most recent webinar.
        </h1>
        <div className="shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] bg-white  mx-auto w-[60%] py-[1rem] mt-8 rounded-lg px-[1rem]">
          <p className="text-center">
            Project power: Connecting educators & industry for student success.
          </p>
        </div>
      </div>

      <div className="relative bg-white mx-auto mt-[5rem] shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] w-full md:w-[86%] md:rounded-2xl py-[2rem] md:py-[4rem]">
        <h1 className="text-center xs:text-[1.5rem] sm:text-[1.7rem] md:text-[1.9rem] lg:text-[2rem] xl:text-[3rem]">
          ScriptTease in number
        </h1>
        <div className="">
          <div>1</div>
          <div>2</div>
