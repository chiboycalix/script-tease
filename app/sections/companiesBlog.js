...
const companiesBlogs = [
  ...
  },
  {
    ...
    img: BlogOne,
    title:
      "Accessing Top Talent: How SkillTribe Connects Companies with Future Industry Leaders",
    category: "SEO",
  ...
  },
  {
    ...
    img: BlogOne,
    title:
      "Corporate Social Responsibility: Enhancing Community Impact with SkillTribe",
    category: "WEB DESIGN",
  ...
  return (
    <div className="grid gap-16 lg:grid-cols-2 grid-cols-1">
      {companiesBlogs.map((companiesBlog) => {
        return (
          <div
            key={companiesBlog.id}
            className="flex flex-col sm:flex-row justify-between gap-5 items-start pb-[2rem] border-b-[1px] cursor-pointer border-[#CFD4D8]"
          >
            <div className="basis-[35%] hover:scale-105">
              <Image
                src={companiesBlog.img}
                className="rounded-md h-[8.3rem]"
