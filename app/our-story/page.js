  ...
  return (
    <div className="w-full">
      <div className="grid grid-cols-2 gap-4 bg-[#1D2C47] px-[1.5rem] xl:px-[5rem] py-[10rem]">
        <div>
          <p className="text-white text-[72px] font-black leading-[85px]">
            Digital Marketing That Drives <br />
            Result
          </p>

          <p className="text-[#859396] mt-4 text-[21px] font-normal leading-[35px] w-[75%]">
      ...
      {/* our approach */}
      <div className="bg-white px-[1.5rem] xl:px-[5rem]">
        <p className="text-[72px] font-black leading-[75px] text-center text-[#374144]">Our Approach</p>
