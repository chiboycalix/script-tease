    ...
    <div>
      ...
      <div className="grid grid-cols-4 gap-10 mt-[2rem]">
        <div className="rounded-md">
          <Image src={BlogOne} alt="BlogOne" className="rounded-md h-[200px]" />
          <div className="mt-[1rem] cursor-pointer">
            ...
            <p className="text-[#869298] text-[16px] mt-[1rem]">22 min read</p>
          </div>
        </div>
        <div className="rounded-md">
          <Image src={BlogOne} alt="BlogOne" className="rounded-md h-[200px]" />
        ...
        <div className="rounded-md bg-[#EFF6FE]">
          ...
          <div className="mt-[1rem] cursor-pointer p-[2rem]">
            ...
            <p className="text-[18px] mt-[1rem]">
              ...
              including how much they cost, what they should include, and how to
              find the best type of SEO service.
            </p>

            <p className="text-[#869298] text-[16px] mt-[2rem]">22 min read</p>
          </div>
        </div>
        <div className="rounded-md bg-[#EFF6FE]">
          <Image
